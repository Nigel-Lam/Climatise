...
export function VictoriaMap() {
    ...
    const vegaSpec = useMemo(() => ({
                ...
                "params": [
                    {"name": "selectedStations", "value": selectedStations}
                ],
                "layer": [
                    ...
                    // Weather station points
                    {
                        ...
                        "encoding": {
                            ...
                            "color": {
                                "condition": {
                                    "test": "indexof(selectedStations, datum.station) >= 0",
                                    "value": "red"
                                },
                                "field": "avg_temp",
                                "type": "quantitative",
                                "scale": {"scheme": "redblue", "reverse": true, "domain": [5, 35]},
                                "title": "Avg Temp (°C)"
                            },
                            "tooltip": [
            ...
            [projectionCenter, projectionScale, selectedStations]
        )
    ;
